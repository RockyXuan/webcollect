...
当前正式发布：`webcollect-2026-07-23-v1.5.1`；扩展 zip `WebCollect-Chrome-Extension-v1.5.1-2026-07-23.zip`。
发布证据：main CI、Release workflow、官方单一 zip 审计与现有主 Chrome Profile 只读验收均已完成，详见 V1.5.1 closeout；V1.5.0 标签组/favicon 与 V1.4.0 Google Drive/完整备份边界继续保持。
