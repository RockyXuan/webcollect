...
目标 Release：`webcollect-2026-07-22-v1.5.0`；目标扩展资产：`WebCollect-Chrome-Extension-v1.5.0-2026-07-22.zip`。实施、数据边界与发布证据见 `docs/audit/webcollect-v1.5.0-tab-packs-favicon-closeout-2026-07-22.md`。
...
1. `AGENTS.md`
2. `AGD.md`
3. `docs/audit/webcollect-v1.5.0-tab-packs-favicon-closeout-2026-07-22.md`
...
11. `docs/audit/webcollect-v1.1.1-ci-closeout-2026-07-12.md`
12. `docs/audit/webcollect-v1.1.0-closeout-2026-07-12.md`
13. `docs/audit/claude-code-review-handoff-2026-07-07.md`
...
当前代码版本：`V1.5.0 / 2026年7月22日`。
正式 Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-21-v1.4.1`。
正式扩展 zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-21-v1.4.1/WebCollect-Chrome-Extension-v1.4.1-2026-07-21.zip`。
发布证据：详见 V1.4.1 closeout；V1.4.0 Google Drive 迁移与完整备份边界继续保持。
历史 RC7：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-15-v1.1.2-rc.7`。
如果旧说明和 `AGD.md` 冲突，以 `AGD.md` 为准。

V1.4.1 只修复网页浮窗键盘事件隔离，不新增存储 key、权限或依赖；V1.4.0 的 Google Drive、完整 JSON、本地优先与数据安全保证保持不变。
