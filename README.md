...
正式 Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-23-v1.5.3`。扩展 zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-23-v1.5.3/WebCollect-Chrome-Extension-v1.5.3-2026-07-23.zip`；SHA-256：`4d41b3e721463446bbde515d470ea6dc8079c85039fd4929c02c8f819c7074e4`。
...
当前正式版本：`V1.5.3 / 2026年7月23日`。
当前正式发布：`webcollect-2026-07-23-v1.5.3`；V1.5.2 保留为稳定回退版本。
