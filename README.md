...
## WebCollect V1.4.0 Google Drive 正式版
...
正式 Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-21-v1.4.0`。扩展 zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-21-v1.4.0/WebCollect-Chrome-Extension-v1.4.0-2026-07-21.zip`。实施、真实迁移和发布证据见 `docs/audit/webcollect-v1.4.0-google-drive-migration-closeout-2026-07-21.md`。
...
当前已发布稳定版：`V1.4.0 / 2026年7月21日`。
正式 Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-21-v1.4.0`。
正式扩展 zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-21-v1.4.0/WebCollect-Chrome-Extension-v1.4.0-2026-07-21.zip`。
发布证据：main CI、tag/Release workflow、官方 zip 与现有已登录主 Chrome Profile 只读验收均已完成，详见 V1.4.0 closeout。
历史 RC7：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-15-v1.1.2-rc.7`。
如果旧说明和 `AGD.md` 冲突，以 `AGD.md` 为准。

V1.4.0 让正式云同步使用每位用户自己的 Google Drive 隐藏应用目录，并提供完整 JSON 备份与恢复；本地 IndexedDB 仍然先保存。V1.3.1 的紧凑顶栏和 V1.3.0 的纯本地智能搜索继续保持不变。
