...
12. `docs/audit/webcollect-v1.1.1-ci-closeout-2026-07-12.md`
13. `docs/audit/webcollect-v1.1.0-closeout-2026-07-12.md`
14. `docs/audit/claude-code-review-handoff-2026-07-07.md`
...
正式 Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-22-v1.5.0`。
正式扩展 zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-22-v1.5.0/WebCollect-Chrome-Extension-v1.5.0-2026-07-22.zip`。
发布证据：详见 V1.5.0 closeout；V1.4.0 Google Drive 迁移与完整备份边界继续保持。
历史 RC7：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-15-v1.1.2-rc.7`。
如果旧说明和 `AGD.md` 冲突，以 `AGD.md` 为准。

V1.5.0 新增标签组和独立 favicon 派生缓存；不移动原收藏，不增加 `tabs` / `tabGroups` 权限。V1.4.0 的 Google Drive、完整 JSON、本地优先与数据安全保证保持不变。
