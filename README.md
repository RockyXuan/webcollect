...
## WebCollect V1.5.3 动态视口适配版

V1.5.3 会根据 WebCollect 实际拥有的页面宽度自动适配，因此 Chrome 使用顶部标签页、左侧标签页或右侧标签页时不需要单独设置。宽屏保持 V1.5.2 原样；约 1680px 时温和缩小顶部三行和经典收藏墙，尽量保留单行工具栏与三列结构；更窄时才切换两行工具栏和两列/单列布局。

本版不使用整页 `zoom` 或 `transform`。导图节点、连线、相机和拖拽坐标保持原逻辑尺寸；自适应密度只存在于当前页面运行时，不写入用户布局、IndexedDB、Chrome storage、Google Drive、快照或同步。实施与验证见 `docs/audit/webcollect-v1.5.3-adaptive-viewport-closeout-2026-07-23.md`。

计划 Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-23-v1.5.3`。计划扩展 zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-23-v1.5.3/WebCollect-Chrome-Extension-v1.5.3-2026-07-23.zip`。发布完成后的实际大小和 SHA-256 将写回 closeout。
...
1. `AGENTS.md`
2. `AGD.md`
3. `docs/audit/webcollect-v1.5.3-adaptive-viewport-closeout-2026-07-23.md`
...
15. `docs/audit/webcollect-v1.1.1-ci-closeout-2026-07-12.md`
16. `docs/audit/webcollect-v1.1.0-closeout-2026-07-12.md`
17. `docs/audit/claude-code-review-handoff-2026-07-07.md`
...
当前候选代码版本：`V1.5.3 / 2026年7月23日`。
当前稳定回退发布：`webcollect-2026-07-23-v1.5.2`；V1.5.3 正式发布证据完成后将更新本段。
V1.5.2 的 GitHub 收藏元数据修复、V1.5.0 标签组/favicon 与 V1.4.0 Google Drive/完整备份边界继续保持。
