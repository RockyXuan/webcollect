...
- Published RC identity: tag `webcollect-2026-07-14-v1.1.2-rc.2`, code commit `aec5b2035dc11ee793693014934494fa2681a450`, asset `WebCollect-Chrome-Extension-v1.1.2-rc.2-2026-07-14.zip`, SHA-256 `7741a66561e8d1f8ab32dba908bd235eab9a6698e6c3b071cb3f6bdb3fc2f5c3`.
- RC Release: `https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-14-v1.1.2-rc.2`; direct zip: `https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-14-v1.1.2-rc.2/WebCollect-Chrome-Extension-v1.1.2-rc.2-2026-07-14.zip`.
- Verified local install folder: `/Users/rockyx/Downloads/WebCollect-v1.1.2-rc.2/unpacked`; it matches `extension/dist` and declares WebCollect `1.1.2` / Manifest V3. Loading it in the signed-in Chrome remains a manual `chrome://extensions` step because Chrome's internal page exposed no safe automation target.
- RC2 adds the edge-peeking mascot: about half of the tilted face remains visible at rest, while hover/focus/drag/open states reveal the full capture pill. An isolated Chromium test verifies both dock sides, exact visible ratios, hover expansion, click-to-open, and zero console errors.
...
- Verified so far: 129 Vitest cases, all 31 legacy scripts, all 12 Playwright cases, TypeScript, ESLint, dependency audit, extension build/artifact/size, and isolated MV3 runtime.
