...
- Published RC identity: tag `webcollect-2026-07-14-v1.1.2-rc.1`, code commit `a8ef9a6b352cf8ac751b9ad9e0ae6e7c98aea834`, asset `WebCollect-Chrome-Extension-v1.1.2-rc.1-2026-07-14.zip`, SHA-256 `a07c1eba1029e6abfdb1895b665b40181c3b717447ec32cf8a2bf782b985a3b7`.
- RC Release: `https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-14-v1.1.2-rc.1`; direct zip: `https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-14-v1.1.2-rc.1/WebCollect-Chrome-Extension-v1.1.2-rc.1-2026-07-14.zip`.
- Verified local install folder: `/Users/rockyx/Downloads/WebCollect-v1.1.2-rc.1/unpacked`; it matches `extension/dist` and declares WebCollect `1.1.2` / Manifest V3. Loading it in the signed-in Chrome remains a manual `chrome://extensions` step because Chrome's internal page exposed no safe automation target.
