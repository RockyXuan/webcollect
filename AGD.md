...
主分支：`main`
当前正式版本：`V1.5.0 / 2026年7月22日`；tag `webcollect-2026-07-22-v1.5.0`；zip `WebCollect-Chrome-Extension-v1.5.0-2026-07-22.zip`。
...
如果这些文件和旧文档冲突，以 `AGD.md`、当前 V1.5.0 closeout 和作为数据基线的 V1.4.0 closeout 为准；旧文档中的独立 Profile B 发布门槛已经退役。
