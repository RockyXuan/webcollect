...
主分支：`main`
当前正式版本：`V1.5.3 / 2026年7月23日`；稳定回退版本为 `V1.5.2`。
...
- 本地门禁：436 Vitest、31 legacy、58 Playwright、类型检查、lint、Web/扩展生产构建和 17.3 MiB 扩展体积检查通过。应用提交 `5cf6280e33213571e4133e5a412ff8d45f8ed919`、main CI `29994891634` 与 Release workflow `29995423399` 均成功。
- 正式 tag 为 `webcollect-2026-07-23-v1.5.3`；官方 Release 只有一个 `17,071,576` bytes 的 zip，SHA-256 为 `4d41b3e721463446bbde515d470ea6dc8079c85039fd4929c02c8f819c7074e4`，官方解包树与最终本地构建一致。
...
0. `docs/audit/webcollect-v1.5.3-adaptive-viewport-closeout-2026-07-23.md`（**当前正式版本**：动态视口适配与发布证据）
0.1 `docs/audit/webcollect-v1.5.2-github-capture-metadata-closeout-2026-07-23.md`（稳定回退发布：GitHub 收藏信息修复与发布证据）
