...
主分支：`main`
当前代码与正式发布版本：`V1.5.2 / 2026年7月23日`；正式 tag 为 `webcollect-2026-07-23-v1.5.2`。
...
0. `docs/audit/webcollect-v1.5.2-github-capture-metadata-closeout-2026-07-23.md`（**当前代码最新**：GitHub 收藏信息修复与发布证据）
0.1 `docs/audit/webcollect-v1.5.1-next-security-closeout-2026-07-23.md`（上一正式发布：Next.js 安全补丁与完整发布证据）
0.2 `docs/audit/webcollect-v1.5.0-tab-packs-favicon-closeout-2026-07-22.md`（标签组、favicon 与完整发布证据）
0.3 `docs/audit/webcollect-v1.4.1-floating-capture-keyboard-closeout-2026-07-21.md`（浮窗快捷键修复与完整发布证据）
0.4 `docs/audit/webcollect-v1.4.0-google-drive-migration-closeout-2026-07-21.md`（Google Drive、完整 JSON、真实迁移与发布证据）
0.5 `docs/audit/webcollect-v1.3.1-header-ui-closeout-2026-07-19.md`（顶栏统一、数据边界与完整发布证据）
0.6 `docs/audit/webcollect-v1.3.0-smart-search-closeout-2026-07-18.md`（本地智能搜索、知识库与数据边界）
0.7 `docs/audit/webcollect-v1.2.2-header-layout-closeout-2026-07-17.md`（顶栏响应式修复与正式发布证据）
0.8 `docs/audit/webcollect-v1.2.1-mindmap-polish-closeout-2026-07-17.md`（Fable 审查打磨与模式记忆）
0.9 `docs/audit/webcollect-v1.2.0-mindmap-closeout-2026-07-16.md`（M0→M7 导图实现与发布）
0.10 `docs/audit/webcollect-v1.1.2-account-sync-closeout-2026-07-13.md`（真实 OAuth、并发收集、RC7 主 Chrome 验收及 Profile B 门槛豁免）
0.11 `docs/audit/webcollect-v1.1.1-ci-closeout-2026-07-12.md`（CI 冷启动与单一 Release 发布链路收口）
0.12 `docs/audit/webcollect-v1.1.0-closeout-2026-07-12.md`（PM 分库核验、WebCollect 云端迁移、备份校验和全项目审计）
0.13 `docs/audit/gpt56-full-audit-execution-2026-07-10.md`（V1.1 测试先行执行日志与历史红绿证据）
0.14 `docs/audit/claude-fable-followup-plan-2026-07-07.md`（Fable 第二轮审查结论 + R1-R4 历史方案）
0.15 `docs/audit/claude-fable-code-review-2026-07-07.md`（Claude Fable 5 第一轮全量代码审查结论）
0.16 `docs/audit/claude-fable-remediation-plan-2026-07-07.md`（第一轮整改执行方案）
0.17 `docs/audit/remediation-execution-log-2026-07-07.md`（第一轮 Codex 执行日志）
1. `AGD.md`
...
如果这些文件和旧文档冲突，以 `AGD.md`、当前 V1.5.2 closeout、V1.5.1 安全补丁 closeout、V1.5.0 功能 closeout 和作为数据基线的 V1.4.0 closeout 为准；旧文档中的独立 Profile B 发布门槛已经退役。
...
- 最新稳定 Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-23-v1.5.1`
- 最新稳定 zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-23-v1.5.1/WebCollect-Chrome-Extension-v1.5.1-2026-07-23.zip`
- 最新稳定 SHA-256：`4667cfd57ede39676b89d87cd9055313bfe52290b134d461b5fa70396f10e29d`
