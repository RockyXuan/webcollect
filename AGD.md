...
## 2026-07-21 V1.4.0 Google Drive 迁移发布候选入口

- 当前发布候选身份：`V1.4.0 / 2026年7月21日`；目标 tag `webcollect-2026-07-21-v1.4.0`；目标资产 `WebCollect-Chrome-Extension-v1.4.0-2026-07-21.zip`。
- 实施与迁移证据：`docs/audit/webcollect-v1.4.0-google-drive-migration-closeout-2026-07-21.md`。正式发布完成前，已发布稳定版仍是 V1.3.1。
...
- 本地门禁当前已通过 395 Vitest、31 legacy、Web/扩展生产构建、17.2 MiB 大小与无 Supabase 扩展运行时扫描；完整 Playwright、生产审计和 GitHub 发布证据仍按 closeout 清单继续。
...
0. `docs/audit/webcollect-v1.4.0-google-drive-migration-closeout-2026-07-21.md`（**当前发布候选最新**：Google Drive、完整 JSON、真实迁移与发布清单）
0.1 `docs/audit/webcollect-v1.3.1-header-ui-closeout-2026-07-19.md`（**当前已发布稳定版**：顶栏统一、数据边界与完整发布证据）
0.2 `docs/audit/webcollect-v1.3.0-smart-search-closeout-2026-07-18.md`（本地智能搜索、知识库与数据边界）
0.3 `docs/audit/webcollect-v1.2.2-header-layout-closeout-2026-07-17.md`（顶栏响应式修复与正式发布证据）
0.4 `docs/audit/webcollect-v1.2.1-mindmap-polish-closeout-2026-07-17.md`（Fable 审查打磨与模式记忆）
0.5 `docs/audit/webcollect-v1.2.0-mindmap-closeout-2026-07-16.md`（M0→M7 导图实现与发布）
0.6 `docs/audit/webcollect-v1.1.2-account-sync-closeout-2026-07-13.md`（真实 OAuth、并发收集、RC7 主 Chrome 验收及 Profile B 门槛豁免）
0.7 `docs/audit/webcollect-v1.1.1-ci-closeout-2026-07-12.md`（CI 冷启动与单一 Release 发布链路收口）
0.8 `docs/audit/webcollect-v1.1.0-closeout-2026-07-12.md`（PM 分库核验、WebCollect 云端迁移、备份校验和全项目审计）
0.9 `docs/audit/gpt56-full-audit-execution-2026-07-10.md`（V1.1 测试先行执行日志与历史红绿证据）
0.10 `docs/audit/claude-fable-followup-plan-2026-07-07.md`（Fable 第二轮审查结论 + R1-R4 历史方案）
0.11 `docs/audit/claude-fable-code-review-2026-07-07.md`（Claude Fable 5 第一轮全量代码审查结论）
0.12 `docs/audit/claude-fable-remediation-plan-2026-07-07.md`（第一轮整改执行方案）
0.13 `docs/audit/remediation-execution-log-2026-07-07.md`（第一轮 Codex 执行日志）
1. `AGD.md`
...
如果这些文件和旧文档冲突，以 `AGD.md` 和当前 V1.4.0 closeout 为准；旧文档中的独立 Profile B 发布门槛已经退役。
