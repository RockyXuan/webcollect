...
- 已验证稳定版：`V1.1.2 / 2026年7月15日`。
- 正式版源码提交：`b7b4f75e8eb8f4f2763b0ede04b1f8a49a12962d`。
- 正式 tag：`webcollect-2026-07-15-v1.1.2`。
- Release：`https://github.com/RockyXuan/webcollect/releases/tag/webcollect-2026-07-15-v1.1.2`。
- zip：`https://github.com/RockyXuan/webcollect/releases/download/webcollect-2026-07-15-v1.1.2/WebCollect-Chrome-Extension-v1.1.2-2026-07-15.zip`。
- zip SHA-256：`79cc7fb01d678e2af24cc8b733353a4a12a6b7ddceba71a5514e7f7f7c9a1192`。
- V1.1.2 的 GitHub CI、Release 工作流、138 条 Vitest、31 组历史脚本、14 条 Playwright、类型检查、Lint、Web/扩展构建和生产依赖审计均已通过。
- `main` 可能在正式版提交之后只有交接文档更新；不要把文档提交误判为新的应用版本。
...
git remote -v
git tag --points-at b7b4f75e8eb8f4f2763b0ede04b1f8a49a12962d
```
...
- 这是大型功能时通常考虑升级到 `V1.2.0`；最终按实际影响范围决定，不能在理解需求前机械定版。
